...
public class ResponseClass {
    ...
    public static ResponseEntity<Map<String, Object>> responseSussess(String message) {
    ...
    public static ResponseEntity<Map<String, Object>> responseSussess(String msg, String inputType ,Object inputdata) {
        Map<String, Object> successResponse = new HashMap<>();
        successResponse.put("status", "success");
